  ...
  return (
    <View style={ styles.calculatorContainer }>
        ...
        <View style={ styles.row }>
           <CalculatorButton onPress={ clean } label='C' color={ colors.lightGray } textColor='#000000' />
           <CalculatorButton onPress={ toggleSign } label='+/-' color={ colors.lightGray } textColor='#000000' />
           <CalculatorButton onPress={ deleteOperation } label='del' color={ colors.lightGray } textColor='#000000' />
